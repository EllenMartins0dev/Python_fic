...
os.mkdir("escola")
os.mkdir("escola/arquivos_processados_pelo_sistema")
...
nome_arquivo_txt = "escola/arquivos_processados_pelo_sistema/alunos.txt"
nome_arquivo_csv = "escola/arquivos_processados_pelo_sistema/notas.csv"
...
shutil.make_archive(nome_arquivo_zip, "zip",
                    "escola/arquivos_processados_pelo_sistema")